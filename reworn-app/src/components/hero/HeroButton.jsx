...
function HeroButton() {
  return (
    <button className="relative inline-block border-0 align-middle text-lg mt-6 bg-transparent cursor-pointer w-64 h-auto group">
      <span className="relative block w-12 h-14 bg-transparent border border-white rounded-full transition-all duration-500 ease-in group-hover:w-full flex items-center justify-center">
      ...
      <span className="absolute top-0 left-2.5 right-0 bottom-0 py-3 ml-7 text-white font-bold text-center uppercase leading-[1.7] transition-all duration-900 ease-in-out">
        Merr Rroba Falas
      </span>
    </button>
  );
