...
function Highlight() {
  return (
    <section className="block mt=[400px]">
      <SectionTitle title="This Week Highlights" />
      <div className="grid grid-cols-3 grid-rows-2 gap-4 h-[100vh] max-w-5xl mx-auto ">
        <Link
          to="clothes"
        ...
        >
          ...
          />
          <h3 className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-3xl font-bold ">
            Patike Ekskluzive
          </h3>
        </Link>
        <Link
